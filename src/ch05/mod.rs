...
pub fn test_layered_net(opti: &mut optimizer::Optimizer, w_initializer: &str, use_dropout: bool) {
    let mnist = Mnist::new();
    let mut net = MultiLayerNet::new(784, 100, 10, w_initializer, use_dropout);
...
pub fn tests() {
    ...
    test_layered_net(&mut optimizer::SGD::new(0.01), "random", false);
}
